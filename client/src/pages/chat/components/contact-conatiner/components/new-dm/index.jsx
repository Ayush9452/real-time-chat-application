    ...
    const searchContacts = async (searchTerm) => {
        try {
            if (searchTerm.length > 0) {
                const res = await apiClient.post(SEARCH_CONTACT_ROUTE, { searchTerm },
            ...
            <Dialog open={openNewContactModel}
                ...
                <DialogContent className="bg-[#181920] border-none text-white w-[400px] h-[400px] flex flex-col ">
                    ...
                    </div>
                    {
                        ...
                        ? <div className="flex-1 md:flex mt-5 flex-col items-center justify-center duration-1000 transition-all ">
                            <Lottie
                        ...
                        <div className="flex flex-col gap-5">
                            {searchedContacts.map((contact) => {
                                return <div key={contact._id} className="flex gap-3 items-center cursor-pointer"
