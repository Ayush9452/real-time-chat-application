...
import { CREATE_CHANNEL_ROUTE, GET_ALL_CONTACTS_ROUTE, HOST } from "@/utils/constants";
...
const CreateChannel = () => {
    ...
    return (
        <div>
            ...
            <Dialog open={openNewChannelModel}
                ...
                <DialogContent className="bg-[#181920] border-none text-white w-[400px] h-[400px] flex flex-col ">
                    ...
                    <div>
                        <MultipleSelector 
                        className="rounded-lg bg-[#2c2e3b] border-none py-2 text-white" defaultOptions={allContacts} 
                    ...
                    <div>
                        ...
                        onClick={createNewChannel}>Create channel</Button>
                    </div>
                </DialogContent>
            </Dialog>
        </div>
